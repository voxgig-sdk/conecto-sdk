...
class CredentialEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CredentialEntity($this->_client, $opts);
    }

    /**
     * @param Credential|array $args Credential data (assoc-array) to store.
     */
    ...
    /**
     * @return Credential|array The current Credential data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Credential fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Credential fields).
     */
     ...
     *
     * @param CredentialLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CredentialLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Credential|array The loaded Credential as an assoc-array at the
