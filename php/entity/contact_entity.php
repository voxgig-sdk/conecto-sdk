...
class ContactEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new ContactEntity($this->_client, $opts);
    }

    /**
     * @param Contact|array $args Contact data (assoc-array) to store.
     */
    ...
    /**
     * @return Contact|array The current Contact data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Contact fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Contact fields).
     */
    ...
    /**
     * List Contact items matching the given filter.
     *
     * @param ContactListMatch|array|null $reqmatch Match filter (any subset
     *   of Contact fields) as an assoc-array; ContactListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Contact[]|array A list of Contact items as assoc-arrays at
     ...
     *
     * @param ContactCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed ContactCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Contact|array The created Contact as an assoc-array at the
