...
class MessageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MessageEntity($this->_client, $opts);
    }

    /**
     * @param Message|array $args Message data (assoc-array) to store.
     */
    ...
    /**
     * @return Message|array The current Message data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Message fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Message fields).
     */
     ...
     *
     * @param MessageCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MessageCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Message|array The created Message as an assoc-array at the
