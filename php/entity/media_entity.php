...
class MediaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new MediaEntity($this->_client, $opts);
    }

    /**
     * @param Media|array $args Media data (assoc-array) to store.
     */
    ...
    /**
     * @return Media|array The current Media data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Media fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Media fields).
     */
     ...
     * Create a new Media.
     *
     * @param MediaCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed MediaCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Media|array The created Media as an assoc-array at the
