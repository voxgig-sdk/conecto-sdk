...
// Conecto SDK Integration entity
...
class IntegrationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new IntegrationEntity($this->_client, $opts);
    }

    /**
     * @param Integration|array $args Integration data (assoc-array) to store.
     */
    ...
    /**
     * @return Integration|array The current Integration data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Integration fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Integration fields).
     */
     ...
     *
     * @param IntegrationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed IntegrationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Integration|array The loaded Integration as an assoc-array at the
    ...
    /**
     * List Integration items matching the given filter.
     *
     * @param IntegrationListMatch|array|null $reqmatch Match filter (any subset
     *   of Integration fields) as an assoc-array; IntegrationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Integration[]|array A list of Integration items as assoc-arrays at
     ...
     *
     * @param IntegrationCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed IntegrationCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Integration|array The created Integration as an assoc-array at the
     *   SDK boundary; throws ConectoError on failure (item-5 convention).
     */
