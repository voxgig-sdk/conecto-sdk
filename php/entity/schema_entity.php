...
class SchemaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SchemaEntity($this->_client, $opts);
    }

    /**
     * @param Schema|array $args Schema data (assoc-array) to store.
     */
    ...
    /**
     * @return Schema|array The current Schema data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Schema fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Schema fields).
     */
     ...
     *
     * @param SchemaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SchemaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Schema|array The loaded Schema as an assoc-array at the
