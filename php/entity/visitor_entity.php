...
class VisitorEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new VisitorEntity($this->_client, $opts);
    }

    /**
     * @param Visitor|array $args Visitor data (assoc-array) to store.
     */
    ...
    /**
     * @return Visitor|array The current Visitor data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Visitor fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Visitor fields).
     */
     ...
     *
     * @param VisitorCreateData|array|null $reqdata Body data as an assoc-array;
     *   a typed VisitorCreateData names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Visitor|array The created Visitor as an assoc-array at the
