...
class ConectoTestRunner
{
    ...
    {
        $live = self::getenv('CONECTO_TEST_LIVE');
        $override = self::getenv('CONECTO_TEST_OVERRIDE');
        ...
        $explain = self::getenv('CONECTO_TEST_EXPLAIN');
...
class_alias('ConectoTestRunner', 'Runner');
class_alias('ConectoHelpers', 'Helpers');
