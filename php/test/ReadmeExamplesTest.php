...
// Conecto SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ConectoSDK::test)
...
{
    private const SDK_CLASS = 'ConectoSDK';
    ...
    private const SDK_BASE = 'conecto_sdk';
