...
// Conecto SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class ConectoTestFeature extends ConectoBaseFeature
{
    ...
    public function init(ConectoContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (ConectoContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (ConectoContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(ConectoContext $ctx, $op, $args): array
    {
