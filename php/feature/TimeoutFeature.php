...
class ConectoTimeoutFeature extends ConectoBaseFeature
{
    ...
    private function _with_timeout(ConectoContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(ConectoContext $_ctx, float $ms): void
    {
        $client = $this->client;
