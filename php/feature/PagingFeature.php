...
class ConectoPagingFeature extends ConectoBaseFeature
{
    ...
    private function _graphql_pre_request(ConectoContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(ConectoContext $ctx): bool
    {
