...
|---|---|---|
| `js/` | @voxgig-sdk/conecto-js | `.github/workflows/publish-js.yml` |
| `ts/` | @voxgig-sdk/conecto | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/conecto-js \
      --repository voxgig-sdk/conecto-sdk \
      --file publish-js.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/conecto-js` shows it, and
`npm trust revoke @voxgig-sdk/conecto-js --id=<id>` removes it.
