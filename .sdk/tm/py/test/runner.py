...
class ConectoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ConectoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ConectoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ConectoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
