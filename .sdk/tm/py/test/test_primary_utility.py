...
from projectname_sdk import ConectoSDK
from projectname_sdk.core.spec import ConectoSpec
from projectname_sdk.core.result import ConectoResult
from projectname_sdk.core.response import ConectoResponse
from projectname_sdk.core.operation import ConectoOperation
from projectname_sdk.core.error import ConectoError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ConectoBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ConectoSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ConectoSDK.test(None, None)
        ...
        class TestInitFeature(ConectoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ConectoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ConectoSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ConectoSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ConectoSDK.test(None, setup_opts)
