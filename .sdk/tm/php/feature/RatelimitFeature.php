...
class ConectoRatelimitFeature extends ConectoBaseFeature
{
    ...
    private function _acquire(ConectoContext $ctx): void
    {
    ...
    private function _track(ConectoContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
