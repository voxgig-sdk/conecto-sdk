...
// Conecto SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class ConectoMakeRequest
{
    public static function call(ConectoContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new ConectoResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new ConectoResponse($fetched);
        } else {
