...
class ConectoGraphql
{
    ...
    // equivalent.
    public static function body(ConectoContext $ctx): mixed
    {
    ...
    public static function errors(ConectoContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
