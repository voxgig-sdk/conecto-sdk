...
// Conecto SDK utility: fetcher

class ConectoFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; ConectoSDK/1.0)';
    ...
    public static function call(ConectoContext $ctx, string $fullurl, array $fetchdef): array
    {
