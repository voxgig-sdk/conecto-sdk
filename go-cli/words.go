...
func registerSDKWords(r *eng.Registry, client *sdk.ConectoSDK) {
...
func runOp(client *sdk.ConectoSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
