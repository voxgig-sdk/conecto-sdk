...
Object.defineProperty(exports, "ConectoEntityBase", { enumerable: true, get: function () { return ConectoEntityBase_1.ConectoEntityBase; } });
...
class ConectoSDK {
    ...
    async direct(fetchargs) {
        if (!this._options.allow.op.includes('direct')) {
            return {
                ok: false,
                err: new Error('ConectoSDK: direct: operation not allowed by' +
    ...
    async graphql(query, variables, ctrl) {
        ...
        if (!options.allow.op.includes('graphql')) {
            return {
                ok: false,
                err: new Error('ConectoSDK: graphql: operation not allowed by' +
        ...
        if (null != errors && Array.isArray(errors) && 0 < errors.length) {
            ...
            const err = new Error('ConectoSDK: graphql: ' +
    ...
    static test(testoptsarg, sdkoptsarg) {
        ...
        const testsdk = new ConectoSDK(sdkopts);
        testsdk._mode = 'test';
        return testsdk;
    }
    tester(testopts, sdkopts) {
        return ConectoSDK.test(testopts, sdkopts);
    }
    toJSON() {
        return { name: 'Conecto' };
    }
    toString() {
        return 'Conecto ' + this._utility.struct.jsonify(this.toJSON());
    }
    [node_util_1.inspect.custom]() {
        return this.toString();
    }
}
exports.ConectoSDK = ConectoSDK;
const SDK = ConectoSDK;
exports.SDK = SDK;
//# sourceMappingURL=ConectoSDK.js.map