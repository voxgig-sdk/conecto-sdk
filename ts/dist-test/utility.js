...
function envOverride(m) {
    if ('TRUE' === process.env.CONECTO_TEST_LIVE ||
        'TRUE' === process.env.CONECTO_TEST_OVERRIDE) {
    ...
    m.CONECTO_TEST_EXPLAIN = process.env.CONECTO_TEST_EXPLAIN || m.CONECTO_TEST_EXPLAIN;
    return m;
}
