...
(0, node_test_1.describe)('SchemaEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        (0, node_assert_1.default)(null != schema_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    if (live) {
        const rawIds = process.env['CONECTO_TEST_SCHEMA_ENTID'];
