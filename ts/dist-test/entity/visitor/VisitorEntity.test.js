...
(0, node_test_1.describe)('VisitorEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['create']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'visitor.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(null != visitor_ref01_data);
    });
});
function basicSetup(extra) {
    ...
    let idmap = transform(['visitor01', 'visitor02', 'visitor03', 'widget01', 'widget02', 'widget03', 'visitor01', 'visitor02', 'visitor03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
