...
(0, node_test_1.describe)('ContactDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-contact', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-contact', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['CONECTO_TEST_CONTACT_ENTID'];
...
//# sourceMappingURL=ContactDirect.test.js.map