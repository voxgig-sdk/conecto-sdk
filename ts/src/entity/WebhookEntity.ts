...
class WebhookEntity extends ConectoEntityBase<Webhook> {
  ...
  async list(this: any, reqmatch?: WebhookListMatch, ctrl?: Control): Promise<WebhookEntity[]> {
