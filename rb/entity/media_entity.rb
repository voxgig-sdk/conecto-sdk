...
class MediaEntity
  ...
  # @return [Media, Hash] the current Media data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Media fields)
  def match_get
  ...
  # Create a new Media.
  #
  # @param reqdata [MediaCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Media, Hash] the created Media; raises ConectoError on failure
