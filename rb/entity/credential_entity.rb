...
class CredentialEntity
  ...
  def make
    opts = @_entopts.dup
    CredentialEntity.new(@_client, opts)
  end
  ...
  # @return [Credential, Hash] the current Credential data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Credential fields)
  def match_get
  ...
  #
  # @param reqmatch [CredentialLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Credential.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Credential, Hash] the loaded Credential; raises ConectoError on failure
