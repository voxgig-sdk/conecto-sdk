...
class IntegrationEntity
  ...
  def make
    opts = @_entopts.dup
    IntegrationEntity.new(@_client, opts)
  end
  ...
  # @return [Integration, Hash] the current Integration data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Integration fields)
  def match_get
  ...
  #
  # @param reqmatch [IntegrationLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Integration.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Integration, Hash] the loaded Integration; raises ConectoError on failure
  ...
  #
  # @param reqmatch [IntegrationListMatch, Hash, nil] match filter (any subset of
  #   Integration fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Integration>, Array] the matching Integration items; raises ConectoError on failure
  ...
  #
  # @param reqdata [IntegrationCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Integration, Hash] the created Integration; raises ConectoError on failure
