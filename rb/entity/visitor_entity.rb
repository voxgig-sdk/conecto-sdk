...
class VisitorEntity
  ...
  def make
    opts = @_entopts.dup
    VisitorEntity.new(@_client, opts)
  end
  ...
  # @return [Visitor, Hash] the current Visitor data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Visitor fields)
  def match_get
  ...
  #
  # @param reqdata [VisitorCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Visitor, Hash] the created Visitor; raises ConectoError on failure
