...
class ContactEntity
  ...
  def make
    opts = @_entopts.dup
    ContactEntity.new(@_client, opts)
  end
  ...
  # @return [Contact, Hash] the current Contact data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Contact fields)
  def match_get
  ...
  #
  # @param reqmatch [ContactListMatch, Hash, nil] match filter (any subset of
  #   Contact fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Contact>, Array] the matching Contact items; raises ConectoError on failure
  ...
  #
  # @param reqdata [ContactCreateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Contact, Hash] the created Contact; raises ConectoError on failure
