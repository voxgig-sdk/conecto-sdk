...
module ConectoTestRunner
  ...
  def self.env_override(m)
    live = getenv("CONECTO_TEST_LIVE")
    override = getenv("CONECTO_TEST_OVERRIDE")
    ...
    explain = getenv("CONECTO_TEST_EXPLAIN")
    m["CONECTO_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = ConectoTestRunner
Helpers = ConectoHelpers
Vs = VoxgigStruct
