...
func (sdk *ConectoSDK) OptionsMap() map[string]any {
...
func (sdk *ConectoSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ConectoSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ConectoSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ConectoSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ConectoSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ConectoSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ConectoSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ConectoSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ConectoSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ConectoSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *ConectoSDK) Contact(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Conversation(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Credential(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Integration(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Media(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Message(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Schema(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Visitor(data map[string]any) ConectoEntity {
...
func (sdk *ConectoSDK) Webhook(data map[string]any) ConectoEntity {
