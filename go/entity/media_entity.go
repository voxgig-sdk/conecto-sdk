...
func NewMediaEntity(client *core.ConectoSDK, entopts map[string]any) *MediaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *MediaEntity) GetName() string { return e.name }
...
func (e *MediaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *MediaEntity) Deleted() bool {
	return e.deleted
}


func (e *MediaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewMediaEntity(e.client, opts)
}

func (e *MediaEntity) Data(args ...any) any {
...
func (e *MediaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *MediaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *MediaEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *MediaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *MediaEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// MediaCreateData and returns an Media. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *MediaEntity) CreateTyped(reqdata MediaCreateData, ctrl map[string]any) (Media, error) {
...
func (e *MediaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *MediaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *MediaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
