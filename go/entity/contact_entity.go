...
func NewContactEntity(client *core.ConectoSDK, entopts map[string]any) *ContactEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContactEntity) GetName() string { return e.name }
...
func (e *ContactEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContactEntity) Deleted() bool {
	return e.deleted
}


func (e *ContactEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContactEntity(e.client, opts)
}

func (e *ContactEntity) Data(args ...any) any {
...
func (e *ContactEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Contact; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContactEntity) DataTyped(data ...Contact) Contact {
	if len(data) > 0 {
		return typedFrom[Contact](e.Data(asMap(data[0])))
	}
	return typedFrom[Contact](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Contact (all fields
// optional at the wire level).
func (e *ContactEntity) MatchTyped(match ...Contact) Contact {
	if len(match) > 0 {
		return typedFrom[Contact](e.Match(asMap(match[0])))
	}
	return typedFrom[Contact](e.Match())
}
...
func (e *ContactEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContactEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *ContactEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContactListMatch and returns []Contact. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *ContactEntity) ListTyped(reqmatch ContactListMatch, ctrl map[string]any) ([]Contact, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Contact](res), nil
}




func (e *ContactEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
// ContactCreateData and returns an Contact. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *ContactEntity) CreateTyped(reqdata ContactCreateData, ctrl map[string]any) (Contact, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Contact{}, err
	}
	return typedFrom[Contact](res), nil
}



func (e *ContactEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContactEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContactEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
