...
func NewVisitorEntity(client *core.ConectoSDK, entopts map[string]any) *VisitorEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *VisitorEntity) GetName() string { return e.name }
...
func (e *VisitorEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *VisitorEntity) Deleted() bool {
	return e.deleted
}


func (e *VisitorEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewVisitorEntity(e.client, opts)
}

func (e *VisitorEntity) Data(args ...any) any {
...
func (e *VisitorEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Visitor; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *VisitorEntity) DataTyped(data ...Visitor) Visitor {
	if len(data) > 0 {
		return typedFrom[Visitor](e.Data(asMap(data[0])))
	}
	return typedFrom[Visitor](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Visitor (all fields
// optional at the wire level).
func (e *VisitorEntity) MatchTyped(match ...Visitor) Visitor {
	if len(match) > 0 {
		return typedFrom[Visitor](e.Match(asMap(match[0])))
	}
	return typedFrom[Visitor](e.Match())
}
...
func (e *VisitorEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *VisitorEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *VisitorEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *VisitorEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// VisitorCreateData and returns an Visitor. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *VisitorEntity) CreateTyped(reqdata VisitorCreateData, ctrl map[string]any) (Visitor, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Visitor{}, err
	}
	return typedFrom[Visitor](res), nil
}



func (e *VisitorEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *VisitorEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *VisitorEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
