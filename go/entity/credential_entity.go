...
func NewCredentialEntity(client *core.ConectoSDK, entopts map[string]any) *CredentialEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CredentialEntity) GetName() string { return e.name }
...
func (e *CredentialEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CredentialEntity) Deleted() bool {
	return e.deleted
}


func (e *CredentialEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCredentialEntity(e.client, opts)
}

func (e *CredentialEntity) Data(args ...any) any {
...
func (e *CredentialEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Credential; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CredentialEntity) DataTyped(data ...Credential) Credential {
	if len(data) > 0 {
		return typedFrom[Credential](e.Data(asMap(data[0])))
	}
	return typedFrom[Credential](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Credential (all fields
// optional at the wire level).
func (e *CredentialEntity) MatchTyped(match ...Credential) Credential {
	if len(match) > 0 {
		return typedFrom[Credential](e.Match(asMap(match[0])))
	}
	return typedFrom[Credential](e.Match())
}
...
func (e *CredentialEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CredentialEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CredentialLoadMatch and returns an Credential. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CredentialEntity) LoadTyped(reqmatch CredentialLoadMatch, ctrl map[string]any) (Credential, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Credential{}, err
	}
	return typedFrom[Credential](res), nil
}



func (e *CredentialEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CredentialEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CredentialEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CredentialEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CredentialEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
