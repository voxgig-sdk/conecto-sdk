...
func NewSchemaEntity(client *core.ConectoSDK, entopts map[string]any) *SchemaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SchemaEntity) GetName() string { return e.name }
...
func (e *SchemaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *SchemaEntity) Deleted() bool {
	return e.deleted
}


func (e *SchemaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewSchemaEntity(e.client, opts)
}

func (e *SchemaEntity) Data(args ...any) any {
...
func (e *SchemaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Schema; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *SchemaEntity) DataTyped(data ...Schema) Schema {
	if len(data) > 0 {
		return typedFrom[Schema](e.Data(asMap(data[0])))
	}
	return typedFrom[Schema](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Schema (all fields
// optional at the wire level).
func (e *SchemaEntity) MatchTyped(match ...Schema) Schema {
	if len(match) > 0 {
		return typedFrom[Schema](e.Match(asMap(match[0])))
	}
	return typedFrom[Schema](e.Match())
}
...
func (e *SchemaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *SchemaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SchemaLoadMatch and returns an Schema. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SchemaEntity) LoadTyped(reqmatch SchemaLoadMatch, ctrl map[string]any) (Schema, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Schema{}, err
	}
	return typedFrom[Schema](res), nil
}



func (e *SchemaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *SchemaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *SchemaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *SchemaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *SchemaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
