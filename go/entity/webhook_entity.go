...
func NewWebhookEntity(client *core.ConectoSDK, entopts map[string]any) *WebhookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *WebhookEntity) GetName() string { return e.name }
...
func (e *WebhookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *WebhookEntity) Deleted() bool {
	return e.deleted
}


func (e *WebhookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewWebhookEntity(e.client, opts)
}

func (e *WebhookEntity) Data(args ...any) any {
...
func (e *WebhookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *WebhookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *WebhookEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *WebhookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
