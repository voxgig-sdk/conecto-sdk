...
const testSeed = `map[string]any{"entity": map[string]any{"action": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contact": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "conversation": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "credential": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "integration": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "media": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "message": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "schema": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "visitor": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "webhook": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
