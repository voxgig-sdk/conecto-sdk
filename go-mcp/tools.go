...
func registerTools(server *mcp.Server, client *sdk.ConectoSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "conecto_list",
		Description: "List records from Conecto. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "conecto_load",
		Description: "Load a single record from Conecto. " +
...
func runOp(client *sdk.ConectoSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
