...
ConversationEntity.__index = ConversationEntity


function ConversationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ConversationEntity)
...
function ConversationEntity:get_name()
  return self._name
end


function ConversationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ConversationEntity.new(self._client, opts)
end
...
function ConversationEntity:mark_deleted()
  self._deleted = true
end


function ConversationEntity:deleted()
  return true == self._deleted
end


function ConversationEntity:data_set(args)
  if args ~= nil then
...
function ConversationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ConversationEntity:match_set(args)
  if args ~= nil then
...
function ConversationEntity:match_get()
...
function ConversationEntity:stream(action, args, callopts)
...
---@param reqmatch ConversationLoadMatch
---@param ctrl? table
---@return Conversation
---@return string? err
function ConversationEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
---@param reqmatch ConversationListMatch
---@param ctrl? table
---@return Conversation[]
---@return string? err
function ConversationEntity:list(reqmatch, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "list",
    ctrl = ctrl,
...
---@param reqdata ConversationCreateData
---@param ctrl? table
---@return Conversation
---@return string? err
function ConversationEntity:create(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "create",
    ctrl = ctrl,
...
---@param reqdata ConversationUpdateData
---@param ctrl? table
---@return Conversation
---@return string? err
function ConversationEntity:update(reqdata, ctrl)
  local utility = self._utility
  local ctx = utility.make_context({
    opname = "update",
    ctrl = ctrl,
...
function ConversationEntity:_run_op(ctx, post_done)
  local utility = self._utility
