...
describe("IntegrationDirect", function()
  it("should direct-list-integration", function()
    ...
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-integration", setup.live and "live" or "unit")
  ...
  it("should direct-load-integration", function()
    local setup = integration_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-integration", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
