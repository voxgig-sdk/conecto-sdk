...
describe("SchemaDirect", function()
  it("should direct-load-schema", function()
    local setup = schema_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-schema", setup.live and "live" or "unit")
...
function schema_direct_setup(mockres)
