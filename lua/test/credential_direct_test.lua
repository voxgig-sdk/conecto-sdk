...
describe("CredentialDirect", function()
  it("should direct-load-credential", function()
    local setup = credential_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-credential", setup.live and "live" or "unit")
...
function credential_direct_setup(mockres)
