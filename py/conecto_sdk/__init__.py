...
from conecto_sdk.utility import register

# Load features
from conecto_sdk.feature.base_feature import ConectoBaseFeature
from conecto_sdk.features import _has_feature, _make_feature
...
class ConectoSDK:
    ...
    def get_utility(self):
        return ConectoUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ConectoSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Integration(self, data=None) -> "IntegrationEntity":
        ...
        from conecto_sdk.entity.integration_entity import IntegrationEntity
    ...
    def Media(self, data=None) -> "MediaEntity":
        ...
        from conecto_sdk.entity.media_entity import MediaEntity
    ...
    def Message(self, data=None) -> "MessageEntity":
        ...
        from conecto_sdk.entity.message_entity import MessageEntity
    ...
    def Schema(self, data=None) -> "SchemaEntity":
        ...
        from conecto_sdk.entity.schema_entity import SchemaEntity
    ...
    def Visitor(self, data=None) -> "VisitorEntity":
        ...
        from conecto_sdk.entity.visitor_entity import VisitorEntity
    ...
    def Webhook(self, data=None) -> "WebhookEntity":
        ...
        from conecto_sdk.entity.webhook_entity import WebhookEntity
        return WebhookEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "ConectoSDK":
        if sdkopts is None:
            sdkopts = {}
