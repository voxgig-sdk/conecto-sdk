...
from conecto_sdk.core.control import ConectoControl
...
from conecto_sdk.core.helpers import get_ctx_prop, to_map
...
class ConectoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, ConectoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ConectoError(code, msg, self)
