# Conecto SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ConectoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ConectoSDK(...) and ConectoSDK.test(...) become
#      ConectoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "conecto_sdk"
_SDK_CLASS = "ConectoSDK"
